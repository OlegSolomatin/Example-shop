...
export default function PlaceOrder () {
    ...
    const itemsPrice = roundTwo(cartItems.reduce((a, c) => a + c.quantity * c.price, 0))
                    ...
                    (
                        ...
                        <div className={'grid md:grid-cols-4 md:gap-5'}>
                            <div className="overflow-x-auto md:col-span-3">
                                <div className="placeorder-items p-5">
                                ...
                                <div className="placeorder-items overflow-x-auto p-5">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <button
                                                ...
                                                className="prymaryButton w-full"
                                            >
